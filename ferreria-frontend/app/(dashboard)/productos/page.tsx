...
export default function ProductosPage() {
    ...
    const productosFiltrados = productos.filter((p) => {
        const coincide = normalizar(p.nombre).includes(normalizar(busqueda));
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-3 gap-2">
                {[
                    { key: "sinStock", label: "Sin stock", count: sinStock, activo: "bg-red-500 border-red-500 text-white shadow-md", inactivo: "bg-red-50 border-red-200 text-red-700" },
                    { key: "pocoStock", label: "Poco stock", count: pocoStock, activo: "bg-orange-400 border-orange-400 text-white shadow-md", inactivo: "bg-orange-50 border-orange-200 text-orange-700" },
                    { key: "ok", label: "Con stock", count: conStock, activo: "bg-green-500 border-green-500 text-white shadow-md", inactivo: "bg-green-50 border-green-200 text-green-700" },
                ].map(f => (
                    <button
                        key={f.key}
